-- Add parent_campaign_id column and hierarchy safeguards for subcampaigns

-- Add parent_campaign_id with self-referencing FK
...
DROP TRIGGER IF EXISTS trg_validate_campaign_parent ON public.campaigns;
...
DROP TRIGGER IF EXISTS trg_prevent_posts_on_parent ON public.posts;
