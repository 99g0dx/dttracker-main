...
-- Campaign create: check before insert, increment after insert (operators only).
...
-- Creator add (workspace_creators): check before insert, increment after insert (operators only).
