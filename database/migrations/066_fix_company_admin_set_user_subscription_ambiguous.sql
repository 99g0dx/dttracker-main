-- Fix: "column reference included_seats is ambiguous" in company_admin_set_user_subscription.
-- The local variable included_seats shadows the table column; use v_included_seats for the variable.
