...
function AppRoutes() {
  ...
  const isPublicRoute = ['/home', '/login', '/signup', '/verification'].includes(location.pathname);
      ...
      <div className="dark min-h-screen bg-background text-foreground">
        ...
        <main className={isPublicRoute ? '' : 'lg:ml-64 p-4 sm:p-6 lg:p-8'}>
          <div className={isPublicRoute ? '' : 'max-w-7xl mx-auto'}>
            <Routes>
              {/* Public routes */}
              <Route path="/home" element={<Home onNavigate={(path) => navigate(path)} />} />
              <Route path="/login" element={<Login onNavigate={(path) => navigate(path)} />} />
              <Route path="/signup" element={<Signup onNavigate={(path) => navigate(path)} />} />
              <Route path="/verification" element={<Verification onNavigate={(path) => navigate(path)} />} />
              ...
              <Route path="/creators/scraper" element={
                <ProtectedRoute>
