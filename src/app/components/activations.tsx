      ...
      {!activeWorkspaceId ? (
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {filtered.map((a: ActivationWithSubmissionCount) => (
            <Card
              key={a.id}
              className="bg-card border-border hover:border-border/80 transition-colors cursor-pointer relative"
                ...
                <div className="flex items-start justify-between gap-2 mb-3">
                  <div className="flex items-center gap-2 min-w-0">
                    {a.type === 'contest' ? (
                      ...
                      <ThumbsUp className="w-5 h-5 flex-shrink-0 text-red-600 dark:text-cyan-400" />
                    )}
                  ...
                  <div className="flex items-center gap-2">
                    {a.visibility === 'community' && (
                      <span className="text-xs font-medium px-2 py-0.5 rounded border bg-purple-500/20 text-purple-600 dark:text-purple-400 border-purple-500/30 flex items-center gap-1">
                        <Users className="w-3 h-3" />
                        Community
                      </span>
                    )}
                    {(!a.visibility || a.visibility === 'public') && (
                      <span className="text-xs font-medium px-2 py-0.5 rounded border bg-red-100/70 dark:bg-blue-500/20 text-red-700 dark:text-blue-400 border-red-200 dark:border-blue-500/30 flex items-center gap-1">
