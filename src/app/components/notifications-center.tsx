...
export function NotificationsCenter() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      localStorage.setItem('dttracker-notifications', JSON.stringify(notifications));
    }
  }, [notifications]);
  ...
  return (
    <div className="relative notifications-dropdown">
      ...
      <button
        ...
        className="relative w-9 h-9 rounded-md bg-white/[0.03] hover:bg-white/[0.06] border border-white/[0.08] flex items-center justify-center transition-colors"
      >
          ...
          <div className="max-h-96 overflow-y-auto">
            {notifications.length > 0 ? (
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between">
                          <span className="text-xs text-slate-500">{getRelativeTime(notification.time)}</span>
                          {!notification.read && (
                            <button
              ...
              <div className="py-12 text-center">
                ...
                <p className="text-xs text-slate-600 mt-1">We'll notify you when something happens</p>
              </div>
            )}
          </div>
        </div>
