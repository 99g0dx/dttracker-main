        ...
        <div className="max-w-[420px] lg:max-w-[1140px] mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-16">
            ...
            <div className="bg-[#E50914]/10 border-2 border-[#E50914] rounded-2xl p-6 lg:p-8 relative lg:scale-105">
              <div className="absolute top-0 right-4 bg-[#E50914] text-white text-xs font-medium px-3 py-1 rounded-b-lg"
                style={{ fontFamily: 'var(--font-body)' }}
              >
                Most Popular
              </div>
              ...
              <div className="w-12 h-12 rounded-lg bg-[#E50914]/20 flex items-center justify-center mb-6">
                <UsersRound size={24} strokeWidth={1.5} className="text-[#E50914]" />
              </div>

              <div className="inline-block px-3 py-1 rounded-full text-xs font-medium mb-4 bg-[#E50914] text-white"
                style={{ fontFamily: 'var(--font-body)' }}
              >
                Most Popular
              </div>
              ...
              <div className="mb-4">
                <span className="text-4xl font-bold text-[#E50914]" style={{ fontFamily: 'var(--font-heading)' }}>
                  $49
                </span>
                ...
                {proPlanFeatures.map((feature, index) => (
                  <div key={index} className="flex items-start gap-3">
                    <div className="mt-0.5 w-5 h-5 rounded-full bg-[#E50914]/20 flex items-center justify-center flex-shrink-0">
                      <Check size={12} strokeWidth={2} className="text-[#E50914]" />
                    </div>
                    <span className="text-sm text-[#A1A1A1]" style={{ fontFamily: 'var(--font-body)' }}>
                      {feature}
                    </span>
            ...
            <div className="bg-[#0C0C0C] border border-[#1F1F1F] rounded-2xl p-6 lg:p-8">
              <div className="w-12 h-12 rounded-lg bg-[#1F1F1F] flex items-center justify-center mb-6">
                <Building2 size={24} strokeWidth={1.5} className="text-[#A1A1A1]" />
              </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-[#0C0C0C] border border-[#1F1F1F] rounded-xl p-6">
                <h4 className="font-medium text-white mb-2" style={{ fontFamily: 'var(--font-body)' }}>
                  Can I cancel anytime?
                </h4>
                <p className="text-sm text-[#A1A1A1]" style={{ fontFamily: 'var(--font-body)' }}>
              ...
              <div className="bg-[#0C0C0C] border border-[#1F1F1F] rounded-xl p-6">
                ...
                <p className="text-sm text-[#A1A1A1]" style={{ fontFamily: 'var(--font-body)' }}>
                  We accept all major credit cards (Visa, MasterCard, American Express), PayPal, and Paystack for African payments.
                </p>
              </div>
