-- Drop old version of the function (without p_workspace_id parameter)
DROP FUNCTION IF EXISTS public.get_or_create_creator(TEXT, TEXT, TEXT, UUID, INT, TEXT, TEXT, TEXT, TEXT, TEXT, UUID);

-- Recreate with p_workspace_id parameter and workspace_creators upsert
