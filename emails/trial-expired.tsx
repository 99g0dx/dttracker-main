...
export default function TrialExpiredEmail() {
  return (
    ...
    >
      ...
      <Paragraph>
        <strong className="text-white">Your data is safe.</strong> We will
        retain your historical campaign data, but you must upgrade to a paid
        plan to resume tracking and access new insights.
      </Paragraph>
